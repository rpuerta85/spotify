...
@Controller
public class FindFavoritesArtistsControllerWeb {
	private static final Logger logger = LogManager.getLogger(FindFavoritesArtistsControllerWeb.class);
	...
	@RequestMapping(value = { ViewUrlConstants.ROOT_PATH+ViewUrlConstants.FIND_FAVORITES_ARTISTS_PATH}, 
