...
@Controller
public class FindAlbumController {
	private static final Logger logger = LogManager.getLogger(FindAlbumController.class);
	...
	public ModelAndView findAlbumAction() {
		logger.info("findAlbum GET");
