...
public class ChangeFavoriteTrackStateController {
	...
	public ModelAndView changeTrackStateAction(@PathVariable("id") String spotifyidTrack) {
		...
		model.setViewName("redirect:/"+ ViewUrlConstants.FIND_FAVORITES_TRACKS_PATH);
