...
public class ChangeFavoriteAlbumViewBean extends GenericView{
	private static final Logger logger = LogManager.getLogger( ChangeFavoriteAlbumViewBean.class);
	private static final String NAME = "changeFavoriteAlbumViewBean";
	private SessionBean sessionBean;
	private String spotifyId;
	private boolean success = false;
	protected MessageSource messageSource;
	public ChangeFavoriteAlbumViewBean(MessageSource messageSource, SessionBean session, String spotifyId) {
	...
	public void process(){
		logger.info("begin ChangeFavoriteAlbumViewBean process method");
		if(sessionBean.getUserWeb()!=null){
			...
			ControllerWsFactory.getInstance(sessionBean)
			               .getChangeStateFavoriteController().changeAlbumFavoriteState(spotifyId, userUUID);
			ModelAndView model = new ModelAndView();
			model.addObject(NAME, this);
			model.setViewName(ViewNameConstants.FIND_FAVORITES_ALBUMS_VIEWNAME);
