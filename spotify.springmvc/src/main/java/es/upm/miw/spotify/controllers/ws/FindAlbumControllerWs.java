...
public class FindAlbumControllerWs extends ControllerWs implements
	...
	@Override
	public Albums findAlbum(String album) {
		...
		albums = restTemplate.getForObject( ControllerWs.URI+RestArtistUris.FIND_ALBUM_REST_URI.replaceAll(RestArtistUris.PARAM,album ),Albums.class );
