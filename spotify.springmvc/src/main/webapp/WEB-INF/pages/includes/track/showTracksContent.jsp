...
window.jsonObject = ${findFavoriteFormBean.mapMsgs['jsonArtists']};
</script>    
...
<div class="panel panel-default">
      <div class="panel-heading">
        <h1>
            ...
            <small><spring:message code="showTracksView.panel.header.subtitle" /><kbd>"${findTrackViewBean.mapMsgs['favoriteName']}"</kbd></small>
        </h1>
              ...
              <div class="panel panel-default">
              		<table class="table table-striped table-condensed" >
            			<tr  ng-repeat="track in vm.json.tracks.items">
                      		<td>
	                          	<a ng-href="${pageContext.request.contextPath}/${findTrackViewBean.mapMsgs['showTrackDetailsUrl']}/{{track.id}}?idArtist={{track.artists[0].id}}&limit={{vm.limit}}"> 
