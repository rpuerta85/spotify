 ...
 >
          <div class="panel panel-default" ng-model="vm.jsonObject" ng-repeat="tema in vm.jsonObject.items track by $index">
                ...
                <h4 class="panel-title">
                  <spring:message
					code="showAlbumDetails.track.list.album" /> {{ tema.disc_number }} -  
                  ...
                  <div class='row'>
                    <div class='col-sm-1'>
                     ...
                     <div class='col-sm-3'>
                      ...
                      <spring:message
					code="showTrackDetails.track.button.duration.title" /> {{tema.duration_ms / 60000 | noFractionCurrency }}:{{(tema.duration_ms /1000)%60 | noFractionCurrency }}
					...
					code="showTrackDetails.track.button.playSong.title" /> &raquo;
                     ...
                     <div class="col-sm-3">
                       <a class="btn btn-primary" 
                          ng-href="${pageContext.request.contextPath}/${showTracksOfAlbumesListViewComponentBean.mapMsgs['showTrackDetailsUrl']}/{{tema.id}}?idArtist={{tema.artists[0].id}}" role="button"> 
                        <spring:message
					code="showAlbumDetails.track.list.details.button" /> &raquo;
                       </a>
                     </div>
                  </div>
                </div>
